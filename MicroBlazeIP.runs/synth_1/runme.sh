...
HD_PWD='C:/Users/redrob1n/VivadoProjects/MicroBlazeIP/MicroBlazeIP.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MicroBlazeIP_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MicroBlazeIP_wrapper.tcl
