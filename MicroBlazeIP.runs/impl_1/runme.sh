...
HD_PWD='C:/Users/redrob1n/VivadoProjects/MicroBlazeIP/MicroBlazeIP.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MicroBlazeIP_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MicroBlazeIP_wrapper.tcl -notrace
