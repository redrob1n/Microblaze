...
HD_PWD='C:/Users/redrob1n/VivadoProjects/MicroBlazeIP/MicroBlazeIP.runs/MicroBlazeIP_pwm_gen_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MicroBlazeIP_pwm_gen_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MicroBlazeIP_pwm_gen_0_0.tcl
